export type PetStatus = "review" | "waiting" | "risk";
...
export const timelineEvents: TimelineEvent[] = [
  {
    id: "TL-1",
    title: "모두싸인 계약 원본 저장",
    description: "서명 완료 후 계약 원본 ID가 CLM 보관함에 자동 저장되었습니다.",
    date: "2026.07.28",
    tone: "normal",
  },
  {
  ...
  },
  {
    id: "TL-3",
    title: "보리 D+30 인증 지연",
    description: "인증 기한이 12일 초과되어 보호소 직접 연락이 필요합니다.",
    date: "2026.07.28",
    tone: "urgent",
  },
];
